...
import com.xlythe.demo.camera.ICameraModule;
...
//            setAutoFlash(mPreviewRequestBuilder); TODO
    ...
    private static final class PhotoSurface extends CameraSurface {
        ...
        private BaseCameraView.OnImageCapturedListener mPhotoListener;
        private File mFile;
        ...
        void initializePicture(File file, BaseCameraView.OnImageCapturedListener listener) {
            mFile = file;
